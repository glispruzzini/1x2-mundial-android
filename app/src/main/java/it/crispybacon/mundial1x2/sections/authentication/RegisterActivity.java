...
public class RegisterActivity extends Activity1x2
    ...
    private Consumer<User> mSuccessConsumer = new Consumer<User>() {
        ...
        public void accept(User user) throws Exception {
            hideLoadingDialog();
            startActivity(HomeActivity.getStartIntent(RegisterActivity.this));
            finish();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextFieldsUtils.disableCopyPaste(mEditRepeatPassword);
